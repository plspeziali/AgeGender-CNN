...
\begin{table}[H]
    ...
    \textit{Multi-task CNN}  &  \multicolumn{2}{c}{640.34}      \\ \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \textit{Multi-task CNN}  & \multicolumn{2}{c}{9}                \\ \bottomrule
    \end{tabular}
\end{table}
...
of the model during various trainings and halting the
process if the loss did not improve
for a certain number of epochs. Then, said number, was used 
as a fixed value to automate the process.
...
\begin{table}[H]
    ...
    \textit{Multi-task CNN}  &  \multicolumn{2}{c}{1.2228}              \\ \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \textit{Multi-task CNN}  &  \multicolumn{2}{c}{1.4058}               \\ \bottomrule
    \end{tabular}
\end{table}
...
of the two individual single-task scenarios.
